...
<div class="even-container">
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <p style="font-size: 20px;">Welcome to Can Haircut<br/>At Can Haircut, Our expert team is here to provide you with the highest quality haircut, 
...
<div class="even-container">
    ...
    <section class="services" id="services">
        ...
        <div class="box">
            ...
            <p>Can Haircut offers free hair styling for our dear custom</p>
       ...
       <i class="fas fa-user-tie"></i>
        ...
        <div class="box">
            ...
            <h3>Total Care</h3>
            <p>At Can Haircut, we take care of all your needs in one place.</p>
...
<div class="even-container">
    ...
    <section class="haircutters" id="haircutters">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <img src="image/haircutter1.jpg" alt="haircutters"  width="200" height="200">
                <h3>Sarp Tarlig</h3>
